...
| For CLI maintainers who need stable output, exits, and errors without changing the human interface. | 15 | Pass |
| Try it with sample data | 5 | Pass |
| Opens a recorded run with four passing checks. | 8 | Pass |
| Free and open source. | 4 | Pass |
| Runs locally. | 2 | Pass |
| Network use is opt-in. | 5 | Pass |
| One declared route. | 3 | Pass |
| Four contract checkpoints. | 3 | Pass |

The headline states the job in eight words. The next sentence names CLI maintainers and the changed situation. The action and outcome can be read aloud in one breath.
...
All fragments are under 10 words. They include “See the contract before an agent does,” “Survey a command in three steps,” “Keep generated commands outside the boundary,” “Add the first contract in two commands,” “Copy install command,” “Declare the route,” “Run isolated fixtures,” and “Review named changes.”
...
No sentence exceeds 22 words. The average audited sentence length is 7.1 words.
...
The description begins with a verb, contains 13 words, uses 75 characters, and contains no banned word.
